...
class BotConfig(BaseConfig):
    ...
    baidu_api_key: str = "VL4nboHMhCyobdkZ5LZzZ22L"  # API Key
    baidu_secret_key: str = "wzHzmBWF2MLZBb2NZiuYiPAFWZnjG2zo"  # Secret Key
    baidu_bot_id: str = "S61587"  # 你闲聊机器人的 id 技能唯一标识，在『我的技能』的技能列表中的技能ID，详情见【请求参数详细说明】
    # 腾讯
